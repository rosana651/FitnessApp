...
from app.video_proccesing import get_squat_video_report, get_plank_video_report, get_wide_pushup_video_report, get_close_grip_pushup_video_report
...
def process_video_task(workout_id: str, video_path: str, exercise_type: str):
    ...
    try:
        ...
        elif exercise_type == "close_grip_pushup":
            result = get_close_grip_pushup_video_report(video_path)
        else:
